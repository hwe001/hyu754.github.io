...
function loadLiverGroup(patientID) {
    if (currentPatient != patientID) {
        ...
        if (scene == undefined) {
            ...
            scene.loadFromViewURL("models/"+patientID+"_surface");
            scene.loadFromViewURL("models/"+patientID+"_bile");
            scene.loadFromViewURL("models/"+patientID+"_hepatic_vein");
            scene.loadFromViewURL("models/"+patientID+"_portal");
