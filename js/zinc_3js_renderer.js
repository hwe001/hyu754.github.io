...
Zinc.Scene = function ( containerIn, rendererIn) {
    ...
    this.loadView = function(viewData)
    {
        ...
        viewPort.farPlane = 10000; //This was modified
 ...
 document.getElementById('videoSource').changed;
             ...
             if(backcameraselected==false){
                if( document.querySelector('select#videoSource').length == 2){
                    var dummyVar =  document.querySelector('select#videoSource').value;
    ...
    this.setThreeJSScene=function(sceneIn){
        scene =sceneIn;
    }
    ...
    //added new function get the camera
    this.getThreeJSCamera=function(){
        return _this.camera;
    }
